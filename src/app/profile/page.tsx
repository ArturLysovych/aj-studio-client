...
export default function profile() {
    ...
    return (
        <div className='w-full h-screen py-[8px] px-[20px] flex flex-col justify-center items-center bg-[#F8F9FA]'>
            <div className="appContainer h-full w-full flex flex-col justify-between items-center">
